...
# file_path = r'F:\ST\Python_Project_ST\Python_programe_From_Bassics_to_Practice\File_exception_8\text_files\pi_digits.txt'
# with open(file_path) as file_object:
#     contents = file_object.read()
#     # rstrip():删除字符串末尾的空白
#     print(contents.rstrip())

# file_path = r'F:\ST\Python_Project_ST\Python_programe_From_Bassics_to_Practice\File_exception_8\text_files'
